...
forward_button=Button(frame_commande,text="Forward", font=("Courrier", 10),bg=couleur_bg,fg="black", command = avancer)
forward_button.place(x=70, y=45)                                                                # création d'un boutton pour avancer

backward_button=Button(frame_commande,text="Backward", font=("Courrier", 10),bg=couleur_bg,fg="black", command = reculer)
backward_button.place(x=65, y=125)                                                              # création d'un bouton pour reculer

left_button=Button(frame_commande,text="Left", font=("Courrier", 10),bg=couleur_bg,fg="black", command = gauche)
left_button.place(x=35, y=80)                                                                   # création d'un bouton pour aller a gauche

right_button=Button(frame_commande,text="Right", font=("Courrier", 10),bg=couleur_bg,fg="black", command = droite)
...
counter_lineaire=count(0,1)                                                                     # compteur pour l'animation

def update(i): 
    print(etat_start)                                                                           # Fonction d'animation
    idx=next(counter_lineaire)
...
start_button=Button(frame_connexion,text="Start", font=("Courrier", 10),bg=couleur_bg,fg="black", command = start)   # ajout du bouton start
start_button.place(x=80, y=80)

stop_button=Button(frame_connexion,text="Stop", font=("Courrier", 10),bg=couleur_bg,fg="black", command = stop) # ajout du bouton stop
